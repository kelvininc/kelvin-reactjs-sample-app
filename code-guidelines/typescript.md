...
> **Based of** [Airbnb JavaScript Style Guide() {](https://github.com/airbnb/javascript#airbnb-javascript-style-guide-) 
...
```javascript
// bad
const KelvinStyleGuide = require('./KelvinStyleGuide');
module.exports = KelvinStyleGuide.es6;

// ok
import KelvinStyleGuide from './KelvinStyleGuide';
export default KelvinStyleGuide.es6;

// best
import { es6 } from './KelvinStyleGuide';
export default es6;
```
...
```javascript
// bad
import * as KelvinStyleGuide from './KelvinStyleGuide';
...
// bad
// filename es6.js
export { es6 as default } from './KelvinStyleGuide';
...
[11.2](#generators--nope) Don’t use generators if you want to transpile to ES5.

> Why? They don’t transpile well to ES5.

<a name="generators--spacing"></a>
[11.3](#generators--spacing) If you must use generators, or if you disregard [the advice](#generators--nope), make sure their function signature is spaced properly. eslint: [`generator-star-spacing`](https://eslint.org/docs/rules/generator-star-spacing)
...
## Performance
 ...
 - [On Layout & Web Performance](https://www.kellegous.com/j/2013/01/26/layout-performance/)
  - [String vs Array Concat](https://jsperf.com/string-vs-array-concat/2) [broken]
  - [Try/Catch Cost In a Loop](https://jsperf.com/try-catch-in-loop-cost/12) [broken]
  - [Bang Function](https://jsperf.com/bang-function) [broken]
  - [jQuery Find vs Context, Selector](https://jsperf.com/jquery-find-vs-context-sel/164) [broken]
  - [innerHTML vs textContent for script text](https://jsperf.com/innerhtml-vs-textcontent-for-script-text) [broken]
  - [Long String Concatenation](https://jsperf.com/ya-string-concat/38) [broken]
